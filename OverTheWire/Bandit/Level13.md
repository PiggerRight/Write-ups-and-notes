...
The challenge provides a file containing a hexdump of a repeatedly compressed file. So I need to reconstruct the original binary file from the hexdump, then repeatedly identify its type and either decompress or extract it until I reach the final plaintext.
